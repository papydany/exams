...
<span id="result"></span>
 ...
 <td width="" class="td"><p>Year / Session</p><label for="select2"></label>
  ...
  <tr>
  <td colspan="6" style="text-align:center; padding:10px;"><input name="submit" type="submit" value="View Registered Probation Students"></td>
  </tr>  
</table>
</form>
		...
		if( 0==mysqli_num_rows ($a) ) {
			...
			while( $r=mysqli_fetch_assoc($a) ) {
				...
				echo '<tr style=" background:',$bg,'">',
						...
						'<td style="text-align:center"><a href="del_prob_reg.php?'.$_SERVER['QUERY_STRING'].'&amp;s='.$r['std_id'].'&amp;c='.$r['stdcourse'].'" onClick="return confirmLink(this, \'Delete This Student Registration.\')">Delete Registration</a></td>',
					 '</tr>';			 
