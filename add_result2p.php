...
TD;
								...
								echo <<<TD
										<td>
										<input style="width:30px; text-align:center" name="std_mark2[$i]" $grade_disabled type="text" tabindex="$i"  value="$grade" onKeyUp="updA(this, 'd$i', 'check[$i]')" size="1" maxlength="1">
