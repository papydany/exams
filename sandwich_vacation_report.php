...
<title>Sandwich Vacation Report</title>
...
<?php
	...
	if( $special ){
		...
		$set['dr'] = 'SANDWICH LONG VACATIONAL RESULTS';
...
echo '<table width="100%" border="0" cellpadding="0" cellspacing="0" class="TABLE">',
	'<thead>',
		'<tr class="thead">',
			...
			'<th colspan="',$aa+1,'">',$result_first_semester,'</th>',
			'<th colspan="',$ab+1,'">',$result_second_semester,'</th>',
			'<th>GPA</th>',
			'<th>CGPA</th>',
			$cod[0],
			'<th>REMARKS</th>',
