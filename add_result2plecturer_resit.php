...
<?php
		...
		&& course_reg.thecourse_id = ".$cccode[0]." 
		AND course_reg.csemester $s_sem 
		AND course_reg.cyearsession = '$_GET[s_session]' 
		&& course_reg.course_season = '$season' 
		&& students_profile.stdfaculty_id = ".$mycourse['faculty_id']." 
		&& students_profile.stddepartment_id = ".$mycourse['department_id']." 
		&& `dept_options`.do_id IN (".substr($myfos2,1,strlen($myfos2)).")
