...
<!--<form action="adv_6.php" method="post" autocomplete="off" onsubmit="return chk(this);" name="register">-->


<form action="adv_10.php" method="post" autocomplete="off" onsubmit="" name="register">
<?php
	if( isset($_GET['i']) ) {
		switch( $_GET['i']) {
			case 1:
...
<input type="submit" value="+ Register Probation Result" name="submit" style="margin:10px; font-family:'Segoe UI', 'Myriad Pro', Tahoma" />
</div>
