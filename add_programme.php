...
if(isset($_POST['adddept']) && ($deptname != " " && $deptcode != " ")){
	...
	$queryab = "SELECT * FROM programme WHERE programme_name = '". $_POST['deptname']. "'";
	...
	$query2ab = "INSERT INTO programme(programme_name) VALUES('$deptname')";
	...
	$msg = '<div class="info">Programme Successfully Added</div>';
	...
	//$_POST['deptcode'] = " ";
		...
		$msg = '<div class="info">Programme already exists!</div>';
	}
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center"><table width="50%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><span>Programme Name</span></td>
        ...
        <tr>
          ...
          <td height="50"><p>&nbsp;
            ...
            <p>
              <input type="submit" name="adddept" id="adddept" onClick="return validate();" value="Add Programme">
            </p></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
