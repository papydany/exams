<?php require ("inc/msgheader.php"); ?>

<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="50%" style="background:#FEFEFE; vertical-align:top">
    	<form method="post" action="form_msg.php">
		<div style="display:block; overflow:hidden; padding:3px 0;">
        <input name="del" type="submit" value="Delete" style="padding:3px 10px 2px;">
        </div>
        <table width="99%" border="0" cellspacing="0" cellpadding="0" class="newtable">
        <thead>
        <tr>
        <th width="3%"><input type="checkbox"  onClick="return checkUncheckAll(this)"></th>
        <th width="20%">Date</th>
		...
		<?php
			...
			$load = mysqli_query( $GLOBALS['connect'], 'SELECT * FROM messaging WHERE m_to = "'.$_SESSION['myexamofficer_id'].'"');
