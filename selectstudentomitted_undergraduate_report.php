...
echo '<div class="bl">
	...
	<div style="color:#222;text-align:center; padding:3px 0; background:#f7f7fe; font-weight:700; font-size:14px;">
		<p>OMITTED EXAMINATION REPORTING SHEET</p>
		<p>',$set['dr'],'</p>
	</div>
	</div>';
	...
	<form class="form-group" method="post" action="selectstudentomitted_display.php" target="_blank">
...
if($num2ac != 0) { 
	...
	echo'<tr>
<th><input type="checkbox" name="id[]" value="'.$ind_std['std_id'].'"/></th><th>'.++$c.'</th><th>'.$ind_std['matric_no'].'</th><th>'.$ind_std['surname']." ".$ind_std['firstname']." ".$ind_std['othernames'].'</th>
</tr>';
}
}
