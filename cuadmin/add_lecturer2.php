...
if(isset($_POST['addlec']) && ($surname != " " && $firstname != " " && $email != " " && $username != " " && $password != " " && $programme != " " && $faculty != " " && $department != " " && $edithright != " " && $mydate != " ")){
	if($_POST['email1'] != " "){
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center"><table width="50%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>FOS</td>
          <td><input type="text" name="fos" id="fos" value="<?php echo $fos; ?>"></td>
        </tr>
        <tr>
          <td>Email</td>
