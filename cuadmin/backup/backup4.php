...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="backup4.php" class="active">BACKUP</a></li>
...
$tables=array('r_publish','course_reg');

// Generate the filename for the backup file
$filess = 'database_backup/category4/backup' . date("d_m_Y_H_i_s",Time()) . '_' . $extname;
