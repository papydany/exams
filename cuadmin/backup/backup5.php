...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="backup5.php" class="active">BACKUP</a></li>
...
$tables=array('studentstatus','students_profile','students_reg','students_results_backup');
// Generate the filename for the backup file
$filess = 'database_backup/category5/backup' . date("d_m_Y_H_i_s",Time()) . '_' . $extname;
