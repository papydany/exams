...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="backup6.php" class="active">BACKUP</a></li>
...
$tables=array('student_status','students_results','suspend_student');

// Generate the filename for the backup file
$filess = 'database_backup/category6/backup' . date("d_m_Y_H_i_s",Time()) . '_' . $extname;
