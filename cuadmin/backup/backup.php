...
$filess = 'backup/backup' . date("d_m_Y_H_i_s",Time()) . '_' . $extname;
...
*/
      	// Print the message
	print('The backup has been created successfully. <br />You can get <b>MySQL dump file</b> <a href="download.php?f=' . $filess . '.sql" class="view">here</a>.<br>' . "\n");
