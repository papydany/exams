...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="backup1.php" class="active">BACKUP</a></li>
...
$tables=array('all_courses','correctional','courses');
// Generate the filename for the backup file
$filess = 'database_backup/category1/backup' . date("d_m_Y_H_i_s",Time()) . '_' . $extname;
