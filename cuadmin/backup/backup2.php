...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="backup2.php" class="active">BACKUP</a></li>
...
$tables = array('degree','departments','dept_options','exam_officers','faculties','level','login','school_certificates');

// Generate the filename for the backup file
$filess = 'database_backup/category2/backup' . date("d_m_Y_H_i_s",Time()) . '_' . $extname;
