...
$query = "SELECT *
	FROM exam_officers
	WHERE examofficer_id = '$myexamofficer_id'
	LIMIT 1";
...
<form action="update_acct.php" method="post" name="form" id="form">
  <table width="90%" border="0" align="center" cellpadding="10" cellspacing="0" class="text9">
    <tr>
    	<?php 
    		if( isset($w_update) ) {
    ...
    <tr>
      <td colspan="2"><b class="hder"><u>Edit Account</u></b></td>
    </tr>
    <tr>
      <td>Title</td>
...
?>
    <tr>
      <td>Username</td>
      <td><input name="eo_username" type="text" id="eo_username" size="30" value="<?php echo $eo_username ?>"></td>
    </tr>
<?php 
}
else {
...
?>
    <tr>
      <td>Password </td>
      <td><input name="eo_password" type="password" id="eo_password" size="30" value="<?php echo $eo_password ?>"></td>
    </tr>
    <tr>
      <td>Confirm Password </td>
      <td><input name="eo_password2" type="password" id="eo_password2" size="30" value="<?php echo $eo_password ?>"></td>
    </tr>
    <tr>
      <td>Email </td>
