...
<title>Undergraduate Omitted Report</title>
...
//report design setting
	...
	if( $special ){
		...
		$set['dr'] = 'OMITTED VACATION DEGREE RESULTS';
		...
		$set['dr'] = 'OMITTED UNDERGRADUATE VACTION RESULTS';
...
//report design setting
	...
	$list_courses_first = fetch_vacation_courses( $d, $p, $fetch_year, 'first semester', $s, $f, $fos );
	$list_courses_sec = fetch_vacation_courses( $d, $p, $fetch_year, 'second semester', $s, $f, $fos );
